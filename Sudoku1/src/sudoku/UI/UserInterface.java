...
public class UserInterface implements  UIContract.View, EventHandler<KeyEvent> {
    private final Stage stage;
    private final Group root;
    // this hashmap stores a unique identifier which is automatically generated,
    //Rather than creating a member variable for every SudokuTextField object (all 81 of them), I instead store these references within a HashMap, and I retrieve
    //them by using their X and Y Coordinates as a key
    ...
    private static final Color WINDOW_BACKGROUND_COLOR = Color.rgb(100, 250, 136);
    ...
    // each TextField is drawn based on an x and y value
